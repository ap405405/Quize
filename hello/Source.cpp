	...
	for (int k = 0; k < 5; k++) {
		...
		for (int j = j_center - thinkness1; j < j_center + thinkness1; j++)
			for (int i = i_center - thinkness2; i < i_center + thinkness2; i++) {
				drawPixel(i, j, 1.0f, 0.0f, 1.0f);
			}
	}
	drawLine(100, 400, 200, 400, 0.0f, 0.0f, 0.0f);
	drawLine(100, 300, 200, 300, 0.0f, 0.0f, 0.0f);
	drawLine2(300, 100, 400, 100, 0.0f, 0.0f, 0.0f);
	drawLine2(300, 200, 400, 200, 0.0f, 0.0f, 0.0f);



	drawLine(100, 100, 150, 150, 0.0f, 0.0f, 0.0f);
	drawLine(150, 150, 200, 100, 0.0f, 0.0f, 0.0f);
	drawLine(100, 100, 200, 100, 0.0f, 0.0f, 0.0f);
	
	drawLine(300, 320, 350, 350, 0.0f, 0.0f, 0.0f);
	drawLine(350, 350, 400, 320, 0.0f, 0.0f, 0.0f);
	drawLine(300, 320, 320, 260, 0.0f, 0.0f, 0.0f);
	drawLine(320, 260, 380, 260, 0.0f, 0.0f, 0.0f);
	drawLine(380, 260, 400, 320, 0.0f, 0.0f, 0.0f);
}


void drawSQ() {

	const int i_center = 500, j_center = 400;
